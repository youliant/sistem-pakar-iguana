  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        $id = $_GET['id'];
        $cek = mysqli_query($koneksi, "SELECT * FROM hasil WHERE id='$id'");
        if(mysqli_num_rows($cek) == 0){

          
        }else{
          $delete = mysqli_query($koneksi, "DELETE FROM hasil WHERE id='$id'");
          if($delete){
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered">
               ...
               <?php
                                                  include'../koneksi.php';
                                                  $no = 1;
  $sql = mysqli_query($koneksi, "SELECT * from hasil INNER JOIN penyakit ON hasil.penyakit = penyakit.penyakit   ");
