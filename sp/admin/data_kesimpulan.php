  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        $cek = mysqli_query($koneksi, "SELECT * FROM penyakit WHERE kd_penyakit='$kd_penyakit'");
        if(mysqli_num_rows($cek) == 0){

          
        }else{
          $delete = mysqli_query($koneksi, "DELETE FROM penyakit WHERE kd_penyakit='$kd_penyakit'");
          if($delete){
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered">
                 <thead>
                                              <tr>
                                                <th><i class=""></i> NO</th>
                                                <th><i class=""></i>Kode Penyakit</th>
                                                <th><i class=""></i>Nama Penyakit</th>
                                                <th><i class=""></i>Info Penyakit</th>
                                              
                                                <th><i class=""></i>Solusi</th>
                                            ...
                                            <tr class="table-white">
                                                ...
                                                <td>
                                                  <div class="btn-group">
                                                     ...
                                                     <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ubah<?php echo $data['id_k']; ?>"><i class="fa fa-edit">Edit</i></a> &nbsp;


                                                    <a class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')"  href="data_kesimpulan.php?aksi=hapus&kd_penyakit=<?php echo $data['kd_penyakit']; ?>" class="btn btn-sm btn-danger" title=""><i class="fa fa-trash">Hapus</i></a>
                                                  </div>
                                                </td>
                                            </tr>
            <!-- Edit Modal !-->
                            ...
                            <div class="modal-body">
                                ...
                                <?php
                                  ...
                                  ?>
                                    ...
                                    <div class="form-group">
                                      <label class="control-label" for="penyakit">info penyakit</label>
                                      <input type="text" name="info_penyakit" class="form-control" id="info_penyakit" value="<?php echo $data['info_penyakit'] ?>" required="">
                                    </div>
                                  ...
                                  ?>
                                        ...
                                        <?php
                                          if (isset($_POST['ubah'])){
                                            ...
                                            $ubah = mysqli_query($koneksi,"UPDATE penyakit SET penyakit='$penyakit', info_penyakit='$info_penyakit', solusi='$solusi' WHERE kd_penyakit='$kd_penyakit' "); 
                                            if($ubah){
                                              ?>
...
$newKode = $str . sprintf("%01s", $no);
                                  ?>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      <label class="control-label" for="penyakit">info penyakit</label>
                                      <input type="text" name="info_penyakit" class="form-control" id="info_penyakit" required="">
                                    </div>
...
//script validasi data
    ...
    $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM penyakit WHERE penyakit='$penyakit' or kd_penyakit='$kd_penyakit'"));

    if ($cek > 0){
    echo "<script>window.alert('nama penyakit sudah ada silahkan cek ulang')
    window.location='data_kesimpulan.php'</script>";
    }else {
    mysqli_query($koneksi,"INSERT INTO penyakit (kd_penyakit, penyakit,info_penyakit, solusi)
                                                VALUES('$kd_penyakit','$penyakit','$info_penyakit','$solusi')");
