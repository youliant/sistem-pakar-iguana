                      ...
                      <td><center><?php echo $data['level'];?></center></td>
                                                <td>
                                                  <div class="btn-group">
                                                    ...
                                                    <a class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini ?')"  href="data_admin.php?aksi=hapus&id_user=<?php echo $data['id_user']; ?>" class="btn btn-sm btn-danger" title=""><i class="fa fa-trash">Hapus</i></a>
